export const table = 'RawUserData';
...
export const schema = [
    ...
    { name: 'a_last_purchase_date', type: 'STRING' },
    { name: 'a_last_visit_date', type: 'STRING' },
    { name: 'a_email_sha256', type: 'STRING' },
    { name: 'a_custom_segment_id', type: 'STRING' },
    { name: 'a_identified_date', type: 'STRING' },
    ...
    { name: 'a_created_date', type: 'STRING', description: 'TIMESTAMP' },
    { name: 'a_updated_date', type: 'STRING', description: 'TIMESTAMP' },
    { name: 'event_name', type: 'STRING' },
    { name: 'e_c_url_pagelocation', type: 'STRING' },
    { name: 'e_product_id', type: 'STRING' },
    { name: 'e_timestamp', type: 'STRING', description: 'TIMESTAMP' },
